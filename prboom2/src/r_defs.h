...
typedef byte segflags_t;

#define SEGF_FAKE     0x01
#define SEGF_ORPHAN   0x02
#define SEGF_CYCLIC   0x04
#define SEGF_MARK     0x08
...
// Implicit seg (generated by BSP divline).
typedef struct iseg_s
{
  fixed_t x1, y1, x2, y2;
  struct subsector_s* subsector;
  int nodenum;
...
#define NO_ISEG ((int)-1)

typedef byte subflags_t;

#define SUBF_DEGENERATE  0x01
#define SUBF_FAKE        0x02
...
typedef struct subsector_s
{
  ...
  // For dsda/bsp
  struct subsector_s* q_next;
  subflags_t flags;
  int numisegs, firstiseg;
} subsector_t;
...
typedef struct
{
  ...
  // Heads linked list of isegs generated by this divline
  int isegs;
} node_t;
