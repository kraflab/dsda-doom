...
void dsda_ArchiveGameFlags(void)
{
  saved_pistolstart = dsda_IntConfig(dsda_config_pistol_start);
  saved_respawnparm = dsda_IntConfig(dsda_config_respawn_monsters);
  saved_fastparm    = dsda_IntConfig(dsda_config_fast_monsters);
  saved_nomonsters  = dsda_IntConfig(dsda_config_no_monsters);
  saved_coop_spawns = dsda_IntConfig(dsda_config_coop_spawns);
...
void dsda_UnArchiveGameFlags(void)
{
