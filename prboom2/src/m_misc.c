...
default_t defaults[] =
{
  ...
  { "input_hexen_arti_icon", { NULL }, { 0 }, UL, UL, def_input, ss_keys, NULL, NULL,
    dsda_input_hexen_arti_icon, { 0, -1, -1 } },
  { "input_hexen_arti_quartz", { NULL }, { 0 }, UL, UL, def_input, ss_keys, NULL, NULL,
    dsda_input_hexen_arti_quartz, { 0, -1, -1 } },
  { "input_hexen_arti_urn", { NULL }, { 0 }, UL, UL, def_input, ss_keys, NULL, NULL,
    dsda_input_hexen_arti_urn, { 0, -1, -1 } },
  ...
  { "input_hexen_arti_torch", { NULL }, { 0 }, UL, UL, def_input, ss_keys, NULL, NULL,
    dsda_input_hexen_arti_torch, { 0, -1, -1 } },
  { "input_hexen_arti_porkalator", { NULL }, { 0 }, UL, UL, def_input, ss_keys, NULL, NULL,
    dsda_input_hexen_arti_porkalator, { 0, -1, -1 } },
  { "input_hexen_arti_wings", { NULL }, { 0 }, UL, UL, def_input, ss_keys, NULL, NULL,
    dsda_input_hexen_arti_wings, { 0, -1, -1 } },
  ...
  { "input_hexen_arti_chaosdevice", { NULL }, { 0 }, UL, UL, def_input, ss_keys, NULL, NULL,
    dsda_input_hexen_arti_chaosdevice, { 0, -1, -1 } },
