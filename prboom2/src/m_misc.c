...
default_t defaults[] =
{
  ...
  MIGRATED_SETTING(dsda_config_gl_texture_internal_hires),
  MIGRATED_SETTING(dsda_config_gl_texture_external_hires),
  MIGRATED_SETTING(dsda_config_gl_hires_override_pwads),
  MIGRATED_SETTING(dsda_config_gl_texture_hqresize),
