...
setup_menu_t gen_settings1[] = { // General Settings screen1
  ...
  {"Render Limit Per Tic",           S_NUM,              m_null, G_X, G_Y+11*8, {"dsda_subframes"}},
...
setup_menu_t gen_settings3[] = { // General Settings screen2
  ...
  {"Permanent Strafe50 (TAS)",    S_YESNO, m_null, G_X, G_Y+ 7*8, {"movement_strafe50"}, 0, M_ChangeSpeed},
  {"Strafe50 On Turns (TAS)",     S_YESNO, m_null, G_X, G_Y+ 8*8, {"movement_strafe50onturns"}, 0, M_ChangeSpeed},
