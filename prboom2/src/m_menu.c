...
setup_menu_t build_keys_settings1[] = {
  ...
  { "Turn Left", S_INPUT, m_build, KB_X, KB_Y + 9 * 8, { 0 }, dsda_input_build_turn_left },
  { "Turn Right", S_INPUT, m_build, KB_X, KB_Y + 10 * 8, { 0 }, dsda_input_build_turn_right },
  { "Strafe Left", S_INPUT, m_build, KB_X, KB_Y + 11 * 8, { 0 }, dsda_input_build_strafe_left },
  { "Strafe Right", S_INPUT, m_build, KB_X, KB_Y + 12 * 8, { 0 }, dsda_input_build_strafe_right },
  { "Use", S_INPUT, m_build, KB_X, KB_Y + 13 * 8, { 0 }, dsda_input_build_use },
